...
//             ScribeGitHubApi scribeApi, GitHubRestClient gitHubRestClient) {
...
//                     user.getLogin(), String.join("', '", settings.organizations())));
//         }
//     }

//     private boolean isUnauthorized(OAuth20Service scribe, OAuth2AccessToken accessToken, String login)
//             throws IOException, ExecutionException, InterruptedException {
//         return isOrganizationMembershipRequired() && !isOrganizationsMember(scribe, accessToken, login);
//     }

//     private boolean isOrganizationsMember(OAuth20Service scribe, OAuth2AccessToken accessToken, String login)
//             throws IOException, ExecutionException, InterruptedException {
...
//   // Build a new OAuth service config for GitHub authentication
//   //   return new ServiceBuilder(settings.clientId())
//   .apiSecret(settings.clientSecret())
//   .callback(context.getCallbackUrl())
//   .userAgent(format("SonarQube/%s (https://www.sonarqube.org)", context.getSonarQubeVersion()));
// }
// }